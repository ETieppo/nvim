...
function M.load(p)
  ...
  -- Telescope
  set(0, 'TelescopeBorder', { fg = p.bg3, bg = p.bg3 })
  set(0, 'TelescopePromptBorder', { fg = p.bg4, bg = p.bg4 })
  set(0, 'TelescopePromptNormal', { fg = p.fg, bg = p.bg4 })
  set(0, 'TelescopePromptPrefix', { fg = p.teal, bg = p.bg4 })
  set(0, 'TelescopeNormal', { fg = 'NONE', bg = p.bg3 })
  set(0, 'TelescopePreviewTitle', { fg = p.bg4, bg = p.purple })
  set(0, 'TelescopePromptTitle', { fg = p.bg4, bg = p.cyan })
  set(0, 'TelescopeResultsTitle', { fg = p.bg3, bg = p.bg3 })
  set(0, 'TelescopeSelection', { fg = 'NONE', bg = p.bg4 })
  set(0, 'TelescopePreviewLine', { fg = 'NONE', bg = p.bg4 })
  set(
    0,
    'TelescopeMatching',
    { fg = p.teal, bg = 'NONE', bold = true, italic = true }
  )
